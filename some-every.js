...
function hasOddNumber(arr) {
    return arr.some(function(element, ind, arr) {
        return element % 2 !== 0;
    })
}
...
function hasAZero(num) {
    const strArray = Array.from(num.toString());    

    return strArray.some(function(digit, index, arr) {
        return digit === '0';
    })
}
...
function hasOnlyOddNumbers(arr) {
    return arr.every(function(element, ind, arr) {
        return element % 2 !== 0;
    })
}
...
function hasCertainKey(arr, key) {
    return arr.every(function(obj, ind, arr) {
        return obj[key];
    })
}
